...
`src/schema/types/customQueries/external/index.ts`
...
`src/schema/types/customQueries/external/types.ts`
...
`src/schema/types/customQueries/external/authentication/index.ts`
...
`src/schema/types/customQueries/external/authentication/types.ts`
