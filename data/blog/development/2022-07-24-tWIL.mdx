...
```typescript:src/schema/types/customQueries/external/index.ts
...
```typescript:src/schema/types/customQueries/external/types.ts
...
```typescript:src/schema/types/customQueries/external/authentication/index.ts
...
```typescript:src/schema/types/customQueries/external/authentication/types.ts
...
```graphql:src/Views/External/externalToken.graphql
...
```typescript:src/schema/index.ts {13-20}
...
```typescript:src/schema/index.ts {13-16}
import { makeSchema, fieldAuthorizePlugin, declarativeWrappingPlugin } from "nexus";
import { SchemaConfig } from "nexus/dist/builder";
import { nexusShield, allow } from "nexus-shield";
import { ForbiddenError } from "apollo-server-core";
