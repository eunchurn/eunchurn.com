...
`http://localhost:3000/b4528200eb584f77aac8b2733ed25e87`을 열어 확인. `yarn build`를 해보면 `.next/server/pages`에 해당 dynamic router의 페이지가 프리렌더링되어 html이 생성된다. 또한 같은 이름으로 `json`파일이 생성되는데 `props`에 노션 컨텐츠 데이터들이 담겨있다.
