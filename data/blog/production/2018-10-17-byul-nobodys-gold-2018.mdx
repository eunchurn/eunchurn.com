...
draft: false
summary: 음반은 열네곡으로 이루어졌으며, ‘모임 별’의 여타 음반들이 그러하듯 밴드 구성원 및 친구, 동료들의 일상사/상념들을 담고 있다.
featured: /static/images/2018/10/byul-nobodys-gold.jpg
categories:
  - production
  - music
tags:
...
<div className="container flex justify-center">
  <iframe
    ...
    frameBorder="no"
    allow="autoplay"
    src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/503147067&color=%23a094ac&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"
  ></iframe>
</div>

### Mix Production

이 앨범에 수록된 곡들은 아마 모임별이 꽤 오래전에 작업했던 곡들로 공연장에서 종종 들을 수 있던 곡들이다. 어느날 파티에 초대를 받아 갔을 때, 태상형이 저에게 믹스를 의뢰하셨고 그 후 2년정도 지난 후 올해 초 아마도 2월부터 믹싱 작업에 들어갈 수 있던것 같다. 모임별 팬으로서 모임별 음반을 믹스한다는 것은 (눈물).

녹음된 트랙을 하나 둘씩 받고 작업하며 밴드 레코딩 소스로 믹스를 해보는 것은 거의 처음이다. 특히 '친밀한 적들'과 같은 리얼 드럼을 녹음한 소스들을 믹스하는 과정에서 정말 공부를 많이 한 것 같다. 각각의 드럼 소스의 모든 소리가 포함되어 있어 공간계는 엄두가 나지 않았고 엠비언스와 룸마이크로 받은 소스들은 그 역할을 발휘하지 못하고 있었기 때문에 여기저기 자료를 찾아보고 시간을 많이 쓴 것 같다.

1. 베이스엔 왜 Empirical Lab의 Distressor 인가
2. Neve 1073을 가지고 킥소스를 약간 찌그려트리며 EQ로 쓰면 좋다
3. Neve 33609의 드럼 버스 처리/컬러라이징
4. MS 믹스와 Reverberation 5. CurveEQ로 톤만들기

제대로 잘 한건지 모르겠다. 오래되고 후진 모니터스피커로 인해 Delivery 에 아쉬운 점이 많이 들린다. 다시 시간을 내어 하고싶지만 프로 세계에서는 실패하면 끝인 것 같다.
...
<div className="aspect-ratio container flex justify-center">
  <iframe
    width="100%"
    height="315"
    src="https://www.youtube.com/embed/OxEChJuL2tY"
    frameBorder="0"
...
<div className="aspect-ratio container flex justify-center">
  <iframe
    width="100%"
    height="315"
    src="https://www.youtube.com/embed/LrOSO7vY50E"
    frameBorder="0"
    allow="autoplay; encrypted-media"
    allowFullScreen
  ></iframe>
