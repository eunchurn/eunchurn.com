...
function Home() {
  return (
    <>
      <h1>My Homepage</h1>
      <Image src="/me.png" alt="Picture of the author" width={500} height={500} unoptimized />
...
```js
<Image alt="ocean" src="/static/images/ocean.jpg" width={256} height={128} unoptimized />
```
